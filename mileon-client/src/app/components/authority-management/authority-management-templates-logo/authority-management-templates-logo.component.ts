...
@Component({
  selector: 'app-authority-management-templates-logo',
  templateUrl: './authority-management-templates-logo.component.html',
  styleUrls: ['./authority-management-templates-logo.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class AuthorityManagementTemplatesLogoComponent extends AuthorityManagementTemplateBaseComponent {
  ...
  requiredTemplates = logoRequiredTemplates;
  logoSearch = SearchByTextEnum.LogosSearch;
