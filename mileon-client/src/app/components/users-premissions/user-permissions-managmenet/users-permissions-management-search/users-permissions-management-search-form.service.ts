...
export class UsersPermissionsManagementSearchFormService {
  form: FormGroup;
  ...
  constructor(private baseFormService: BaseFormService) {
    this.form = this.baseFormService.createFormGroup(UsersPermissionsFilterOptions);
    this.searchForm = this.baseFormService.createFormGroup(UsersPermissionsFilterOptions);
  }
}
