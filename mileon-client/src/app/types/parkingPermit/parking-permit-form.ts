...
export class CitizenForm {
  ...
  constructor(citizenFormFields: CitizenForm) {
    ...
    this.interiorMinistryHomeAddress =
      citizenFormFields.interiorMinistryHomeAddress;
    this.interiorMinistryPostalAddress =
      citizenFormFields.interiorMinistryPostalAddress;
